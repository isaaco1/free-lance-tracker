# Freelancer Timer v3 - Added Hourly Rate + £ Calculation + Pause Tracking
...
class TimerApp:
        ...
        if not os.path.exists("sessions.csv"):
            with open("sessions.csv", "w", newline="") as f:
                ...
                writer.writerow([
                    ...
                    "paused_duration_min", "rate_gbp", "earned_gbp"
                ])
    ...
    def stop_timer(self):
        ...
        # If stopped while paused, count final pause duration
        if self.paused:
            pause_duration = int(time.time() - self.pause_start_time)
            self.total_pause_seconds += pause_duration
        ...
        with open("sessions.csv", "a", newline="") as f:
            ...
            writer.writerow([
                ...
                self.start_dt, stop_dt, total_minutes, pause_minutes, rate, earned
            ])
